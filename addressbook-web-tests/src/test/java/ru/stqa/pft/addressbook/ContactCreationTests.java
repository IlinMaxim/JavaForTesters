...
public class ContactCreationTests {
  ...
  public void createNewContact() throws Exception {
    initContactCreation();
    fillContactForm(new ContactData("FirstName", "MiddleName", "LastName", "Nickname", "Title", "Company", "Address", "HomeTelephone", "MobileTelephone", "WorkTelephone", "Fax", "FirstEmail"));
